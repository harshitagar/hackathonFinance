		...
		networkProvider.get(url, null, headers,
			function(res){
                ...
                if(kony.sdk.getPlatformName() !== kony.sdk.constants.PLATFORM_IOS){
                    kony.location.setGeofencesCallback(this.manageGeoBoundariesCallback);
                }
...
kony.sdk.util.loadMetadataFromDs = function(dsAppMetaData, dsAppServiceDoc) {
    ...
    if(kony.sdk.util.isAppConfigEncrypted()) {
        if(!kony.sdk.isNullOrUndefined(dsAppMetaData)) {
            dsAppMetaData.appKey = kony.sdk.util.decryptAppConfig(dsAppMetaData.appKey);
            dsAppMetaData.appSecret = kony.sdk.util.decryptAppConfig(dsAppMetaData.appSecret);
            dsAppMetaData.serviceUrl = kony.sdk.util.decryptAppConfig(dsAppMetaData.serviceUrl);
        }
        if(!kony.sdk.isNullOrUndefined(dsAppServiceDoc)) {
